              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                ...
                <button
                  onClick={() => {
                    ...
                    console.log('📦 Passing to endorse:', {
                      policyNumber,
                      selectedPlan,
                      selectedRiders,
                      basePremium,
                  ...
                  className="w-full sm:w-auto flex items-center justify-center gap-2.5 px-8 py-4 rounded-xl bg-blue-500/20 border border-blue-500/40 text-blue-400 font-semibold text-base transition-all hover:bg-blue-500/30 hover:border-blue-500/60 active:scale-[0.98]"
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
